...
HRESULT CEnemy::Load(void)
{
	...
	//テクスチャ読み込み
	D3DXCreateTextureFromFile(pDevice, "data/Texture/Enemy/enemy1.png", &m_apTexture[TEX_TYPE_NORMAL]);
	D3DXCreateTextureFromFile(pDevice, "data/Texture/Enemy/enemy2.png", &m_apTexture[TEX_TYPE_BLUE]);
	D3DXCreateTextureFromFile(pDevice, "data/Texture/Enemy/enemy3.png", &m_apTexture[TEX_TYPE_RED]);
	D3DXCreateTextureFromFile(pDevice, "data/Texture/Enemy/Wepon1.png", &m_apTexture[TEX_TYPE_SHIP_BATTERY]);
	return S_OK;
}
//******************************************************************************
// テクスチャ破棄
