...
HRESULT CNumber::Init()
{
	...
	// テクスチャ
	pVtx[0].tex = D3DXVECTOR2(m_nNumber * TEXTURE_X, 0.0f);
	pVtx[1].tex = D3DXVECTOR2(m_nNumber * TEXTURE_X + TEXTURE_X, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(m_nNumber * TEXTURE_X, TEXTURE_Y);
	pVtx[3].tex = D3DXVECTOR2(m_nNumber * TEXTURE_X + TEXTURE_X, TEXTURE_Y);
