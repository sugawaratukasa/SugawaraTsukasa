...
HRESULT CParticle::Load(void)
{
	...
	// テクスチャ読み込み
	D3DXCreateTextureFromFile(pDevice, "data/Texture/Effect/particle001.png", &m_pTexture[TEX_TYPE_CIRCLE]);
	D3DXCreateTextureFromFile(pDevice, "data/Texture/Effect/fire002.png", &m_pTexture[TEX_TYPE_EXPLOSION]);
	return S_OK;
}
//******************************************************************************
// テクスチャ破棄
