...
// マクロ定義
//******************************************************************************
#define COLOR_VALUE	(D3DXCOLOR(1.0f,1.0f,1.0f,1.0f))
//******************************************************************************
// 静的メンバ変数
//******************************************************************************
...
HRESULT CBg::Load(void)
{
	...
	//テクスチャ読み込み
	D3DXCreateTextureFromFile(pDevice, "data/Texture/BackGround/bg2.png", &m_apTexture[TYPE_FARST_BG]);
	D3DXCreateTextureFromFile(pDevice, "data/Texture/BackGround/bg101.png", &m_apTexture[TYPE_SECOUND_BG]);
	D3DXCreateTextureFromFile(pDevice, "data/Texture/BackGround/bg102.png", &m_apTexture[TYPE_THIRD_BG]);
	return S_OK;
}
//******************************************************************************
// テクスチャ破棄
...
CBg::CBg(int nPriority) : CScene(nPriority)
{
	...
	m_texsizeX	= INIT_FLOAT;
	m_texsizeY	= INIT_FLOAT;
	m_fFastMove = INIT_FLOAT;
