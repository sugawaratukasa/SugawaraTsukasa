...
#define RANDUM_SPEED_MAX		(1000)															// 移動量の最大値
#define RANDUM_SPEED_MIN		(500)															// 移動量の最小値
...
// 爆発生成処理関数
//******************************************************************************
void CParticle_Circle::CreateParticleEffect(D3DXVECTOR3 pos, D3DXVECTOR3 size)
{
		// 5回繰り返す
		for (int nCount = INIT_INT; nCount < MAX_PARTICLE; nCount++)
		{
			// 角度を360度ランダムに
